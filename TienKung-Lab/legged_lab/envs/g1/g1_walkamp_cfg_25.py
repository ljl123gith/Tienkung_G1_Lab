...
from legged_lab.envs.g1.g1_config_25 import G1FlatAgentCfg_25, G1FlatEnvCfg_25, G1RewardCfg ,G1WalkGaitRewardCfg25
...
@configclass
class G1WalkAmpRewardCfg_25(G1WalkGaitRewardCfg25):
...
@configclass
class G1WalkAmpEnvCfg_25(G1FlatEnvCfg_25):
    """G1 flat terrain AMP-walk environment config."""
    
    reward = G1WalkAmpRewardCfg_25()
    gait = GaitCfg()
...
@configclass
class G1WalkAmpAgentCfg_25(BaseAgentCfg):
    """AMP training config for G1 25-DoF walking."""

    experiment_name: str = "g1_walkamp_25"
    wandb_project: str = "g1_walkamp_25"
    runner_class_name: str = "AmpOnPolicyRunner_25"
